...
We will cover what this looks like with AdvantageKit [here](2.6_AdvantageKit.md), but at a high level, this means that we have both a sim and real version of each mechanism in our code.
...
- Follow [this tutorial](2.10_KitbotSim.md) to convert your kitbot code to AdvantageKit and simulation.
